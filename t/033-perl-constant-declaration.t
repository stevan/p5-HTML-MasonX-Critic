...
subtest '... simple compiler test using perl blocks and queries' => sub {
    ...
    subtest '... testing the once block' => sub {
        ...
        my ($FOO, $BAR) = HTML::MasonX::Inspector::Query::PerlCode->find_constant_declarations( $once );

        isa_ok($FOO, 'HTML::MasonX::Inspector::Perl::ConstantDeclaration');
        ...
        isa_ok($BAR, 'HTML::MasonX::Inspector::Perl::ConstantDeclaration');
