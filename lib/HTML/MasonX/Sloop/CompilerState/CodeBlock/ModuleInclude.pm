package HTML::MasonX::Sloop::CompilerState::CodeBlock::ModuleInclude;
...
use HTML::MasonX::Sloop::CompilerState::CodeBlock::ModuleInclude::Import;
...
sub imports {
	...
	$self->{_imports} = [
		map HTML::MasonX::Sloop::CompilerState::CodeBlock::ModuleInclude::Import->new(
			token => $_
