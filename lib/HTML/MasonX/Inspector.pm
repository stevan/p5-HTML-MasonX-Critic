...
HTML::MasonX::Inspector - Tools for inspecting a HTML::Mason codebase
...
interface of a different phase of the codes life cycle.
...
These are the result objects of the PerlCode queries.
